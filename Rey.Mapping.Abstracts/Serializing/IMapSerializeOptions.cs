...
namespace Rey.Mapping {
    ...
    public interface IMapSerializeOptions<TFrom> : IMapSerializeOptions {
        IMapSerializeOptions<TFrom> Ignore<TField>(Expression<Func<TFrom, TField>> field);

        IMapSerializeOptions<TFrom> Map<TField>(Expression<Func<TFrom, TField>> field, IEnumerable<MapPath> to);
        IMapSerializeOptions<TFrom> Map<TField>(Expression<Func<TFrom, TField>> field, params MapPath[] to);
    }
}
